    ...
    try {
        ...
        if (!empty($Password)) {
            ...
            if ($Password == $Password1) {
                ...
                $sql = "UPDATE `tbl_hoa` SET `firstname` = '$Firstname', `lastname` = '$Lastname', `password` = '$Password', `email` = '$Email', `position` = '$Position', `contact` = '$Contact', `email` = '$Email', `password` = '$HashPassword' WHERE id = '$ID';";
